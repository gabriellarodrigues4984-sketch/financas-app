    ...
    <header className="fixed top-0 left-0 w-full z-40 bg-surface-container-lowest/90 backdrop-blur-md border-b border-outline-variant px-4 md:px-8 py-3">
      <div className="max-w-5xl mx-auto flex justify-between items-center gap-4">
        <div className="flex items-center gap-2">
          ...
          <span className="font-display font-bold text-lg text-brand-blue">Modern Ledger</span>
        </div>
        ...
        <div className="flex items-center gap-3" ref={menuRef}>
          <button
            className="material-symbols-outlined text-on-surface-variant cursor-pointer hover:bg-surface-container-low p-1.5 rounded-full"
